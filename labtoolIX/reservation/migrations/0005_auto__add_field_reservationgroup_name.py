...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ReservationGroup.name'
        db.add_column('reservation_reservationgroup', 'name',
                      self.gf('django.db.models.fields.CharField')(default='Maunz', max_length=30),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ReservationGroup.name'
        db.delete_column('reservation_reservationgroup', 'name')
