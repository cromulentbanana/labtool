...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing M2M table for field members on 'ReservationGroup'
        db.delete_table('reservation_reservationgroup_members')


    def backwards(self, orm):
        # Adding M2M table for field members on 'ReservationGroup'
        db.create_table('reservation_reservationgroup_members', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('reservationgroup', models.ForeignKey(orm['reservation.reservationgroup'], null=False)),
            ('user', models.ForeignKey(orm['auth.user'], null=False))
        ))
        db.create_unique('reservation_reservationgroup_members', ['reservationgroup_id', 'user_id'])
